(function ($) {
    ...
    if ($("body").hasClass("horizontal-page")) {
        // Jika halaman ini adalah halaman khusus, atur layout ke horizontal-wrapper
        $(".page-wrapper").attr("class", "page-wrapper horizontal-wrapper");
        $("#sidebar-landing").addClass("d-none");

        // localStorage.setItem("page-wrapper-cuba", "horizontal-wrapper");
    } else {
        // Jika bukan halaman khusus, gunakan layout default (compact-wrapper)
        $(".page-wrapper").attr(
            "class",
