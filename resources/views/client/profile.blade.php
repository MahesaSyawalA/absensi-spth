                ...
                <div class="user-image">
                    <div class="avatar">
                        <div class="common-align">
                            ...
                            <div class="user-designation"><a target="_blank" href="">Ade Irfan Yulianto</a>
                ...
                <div class="row g-3">
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="ttl-info text-start">
                            <h6><i class="icon-id-badge"></i> Nip</h6><span>000000000000000001</span>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="ttl-info text-start">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="ttl-info text-start">
                            <h6><i class="fa-solid fa-calendar-days pe-2"></i>Tanggal Lahir</h6><span>1995-06-19</span>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="ttl-info text-start">
